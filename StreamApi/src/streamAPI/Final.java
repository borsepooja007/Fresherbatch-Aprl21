...
public class Final {
	...
	public static void main(String[] args) {
		...
		List<News> news1 = Arrays.asList(
				...
				new News(22, "Sana", "meera", " the new budget lis is good"),
				new News(23, "ani", "pavan", "Finally ipl Started"), new News(23, "vire", "neha", "I supported to MI "),
				new News(24, "Ashish", "Narhsa", "wbu 12 exam"),
				new News(22, "sayali", "yadnik", "without budget list face too much problem"),
				new News(23, "tara", "lina", "ipl india ka festival"));
		...
		List<Transaction> Tran = Arrays.asList(
				...
				new Transaction(new Trader("meera", "Pune"), 2014, 20000),
